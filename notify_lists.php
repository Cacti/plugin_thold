		...
		if (isset($_POST["save_list"])) {
			...
			if ($_POST["drp_action"] == "1") { /* associate */
				...
				for ($i=0;($i<count($selected_items));$i++) {
					...
					/* set the global/list election */
					db_execute("UPDATE host SET thold_send_email=" . get_request_var_request("notification_action") . " WHERE id=" . $selected_items[$i] . " AND thold_send_email=" . get_request_var_request('id'));
				}
			}
