...
function thold_draw_navigation_text ($nav) {
	...
	$nav['thold_view_host.php:'] = array('title' => 'Recent Device Failures', 'mapping' => 'index.php:', 'url' => 'thold_view_host.php', 'level' => '1');
	...
	foreach ($fields_host_edit2 as $f => $a) {
		...
		if ($f == 'disabled') {
			$fields_host_edit3['thold_send_email'] = array(
				...
				'description' => 'Which Notification List(s) of should be notified about Device Up/Down events?',
...
function thold_config_settings () {
	...
	$settings['alerts'] = array(
		...
		'thold_baseline_header' => array(
			'friendly_name' => 'Baseline Presets',
			'method' => 'spacer',
		),
		...
		'thold_alerting_header3' => array(
			'friendly_name' => 'SNMP Notification Presets',
			'method' => 'spacer',
		),
		...
		'alert_email' => array(
			'friendly_name' => 'Dead Device Notifications Email',
			'description' => 'This is the Email Address that the Dead Device Notifications will be sent to if the Global Notification List is selected.',
			'method' => 'textbox',
			'size' => 80,
			'max_length' => 255,
		),
		'thold_down_subject' => array(
			'friendly_name' => 'Down Device Subject',
			'description' => 'This is the Email subject that will be used for Down Device Messages.',
			'method' => 'textbox',
			'size' => 80,
			'max_length' => 255,
			'default' => 'Device Error: <DESCRIPTION> (<HOSTNAME>) is DOWN',
		),
		'thold_down_text' => array(
			'friendly_name' => 'Down Device Message',
			'description' => 'This is the message that will be displayed as the message body of all UP / Down Device Messages (255 Char MAX).  HTML is allowed, but will be removed for text only Emails.  There are several descriptors that may be used.<br>&#060HOSTNAME&#062  &#060DESCRIPTION&#062 &#060UPTIME&#062  &#060UPTIMETEXT&#062  &#060DOWNTIME&#062 &#060MESSAGE&#062 &#060SUBJECT&#062 &#060DOWN/UP&#062 &#060SNMP_HOSTNAME&#062 &#060SNMP_LOCATION&#062 &#060SNMP_CONTACT&#062 &#060SNMP_SYSTEM&#062 &#060LAST_FAIL&#062 &#060AVAILABILITY&#062 &#060TOT_POLL&#062 &#060FAIL_POLL&#062 &#060CUR_TIME&#062 &#060AVG_TIME&#062 &#060NOTES&#062',
			'method' => 'textarea',
			'class' => 'textAreaNotes',
			'textarea_rows' => '7',
			'textarea_cols' => '80',
		...
		'thold_up_subject' => array(
			'friendly_name' => 'Recovering Device Subject',
			'description' => 'This is the Email subject that will be used for Recovering Device Messages.',
			'method' => 'textbox',
			'size' => 80,
			'max_length' => 255,
			'default' => 'Device Notice: <DESCRIPTION> (<HOSTNAME>) returned from DOWN state',
		),
		'thold_up_text' => array(
			'friendly_name' => 'Recovering Device Message',
			'description' => 'This is the message that will be displayed as the message body of all UP / Down Device Messages (255 Char MAX).  HTML is allowed, but will be removed for text only Emails.  There are several descriptors that may be used.<br>&#060HOSTNAME&#062  &#060DESCRIPTION&#062 &#060UPTIME&#062  &#060UPTIMETEXT&#062  &#060DOWNTIME&#062 &#060MESSAGE&#062 &#060SUBJECT&#062 &#060DOWN/UP&#062 &#060SNMP_HOSTNAME&#062 &#060SNMP_LOCATION&#062 &#060SNMP_CONTACT&#062 &#060SNMP_SYSTEM&#062 &#060LAST_FAIL&#062 &#060AVAILABILITY&#062 &#060TOT_POLL&#062 &#060FAIL_POLL&#062 &#060CUR_TIME&#062 &#060AVG_TIME&#062 &#060NOTES&#062',
			'method' => 'textarea',
			'class' => 'textAreaNotes',
			'textarea_rows' => '7',
		...
		'thold_alert_text' => array(
			...
			'textarea_rows' => '5',
			'textarea_cols' => '80',
			'default' => 'An Alert has been issued that requires your attention. <br><br><strong>Device</strong>: <DESCRIPTION> (<HOSTNAME>)<br><strong>URL</strong>: <URL><br><strong>Message</strong>: <SUBJECT><br><br><GRAPH>',
		),
		'thold_warning_text' => array(
			...
			'textarea_rows' => '5',
			'textarea_cols' => '80',
			'default' => 'A warning has been issued that requires your attention. <br><br><strong>Device</strong>: <DESCRIPTION> (<HOSTNAME>)<br><strong>URL</strong>: <URL><br><strong>Message</strong>: <SUBJECT><br><br><GRAPH>',
		),
