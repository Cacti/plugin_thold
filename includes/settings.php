...
function thold_draw_navigation_text ($nav) {
	...
	$nav['thold.php:editalert'] = array('title' => 'Thresholds - Edit Alert', 'mapping' => 'index.php:', 'url' => 'thold.php', 'level' => '1');
	$nav['thold.php:addalert'] = array('title' => 'Thresholds - Add Alert', 'mapping' => 'index.php:', 'url' => 'thold.php', 'level' => '1');
	...
	$nav['thold_templates.php:addalert'] = array('title' => 'Threshold Templates - Add Alert', 'mapping' => 'index.php:', 'url' => 'thold_templates.php', 'level' => '1');
	$nav['thold_templates.php:editalert'] = array('title' => 'Threshold Templates - Edit Alert', 'mapping' => 'index.php:', 'url' => 'thold_templates.php', 'level' => '1');
